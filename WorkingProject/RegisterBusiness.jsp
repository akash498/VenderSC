...
<div class="container">
  ...
  <%if (request.getAttribute("error") != null || request.getAttribute("error") == ""){ %>
			...
			<%} %>
  <form action="RegisterBusiness" method="POST" id="search-form" enctype="multipart/form-data">
  ...
  <div class="form-group">
      <label for="text" style=" font-family: 'Merriweather', serif;">Business/Organization Description:</label>
    ...
    <div class="form-group">
      <label for="pwd" style=" font-family: 'Merriweather', serif;">Confirm Password:</label>
      <input type="password" class="form-control" id="pwd" name = "confirm" placeholder="Enter password again">
    </div>
