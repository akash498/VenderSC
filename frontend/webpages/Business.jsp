    	    ...
    	    <div class = "row d-flex justify-content-center" style="border-bottom: 2px solid black; font-family:varsity;">
    			...
    			<div class = "col-md-3 ">
  				...
  				<div class = "col-md-6">
  					...
  					%>
  					<a class="btn btn-outline-danger my-2 my-sm-0" href="BusinessServlet?busiIndex=<%= request.getParameter("busiIndex") %>&prodNum=<%= products.get(i).getProductId() %>" 
  					style="	border: 2px solid; color: #FFCC00;background-color:#990000; font-family: varsity;">VIEW</a>
					<br><br>
  				</div>
