...
<div class="container">
  ...
  <br>
  <br>
  <h2 style=" font-family: 'Merriweather', serif;">Register  Here</h2>
  <br>
  <br>
  ...
  <form method="POST" action="RegisterUser">
    <div class="form-group">
      <label for="text" style=" font-family: 'Merriweather', serif;">Name:</label>
  ...
  <div class="form-group">
    <label for="exampleFormControlFile1" style=" font-family: 'Merriweather', serif;">Upload a Profile Picture here:</label>
    ...
    <div class="form-group">
      <label for="pwd" style=" font-family: 'Merriweather', serif;">Password:</label>
      <input type="password" class="form-control" id="pwd" name = "confirm"placeholder="Enter password">
    </div>
